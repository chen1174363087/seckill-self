package com.chenxin.config.mybatis_plus_generator;
...
public class CodeGenerator {
    @Value("${spring.datasource.url:jdbc:mysql://localhost:3306/activiti?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8&allowPublicKeyRetrieval=true}")
